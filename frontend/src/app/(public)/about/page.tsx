...
export default async function AboutPage() {
  ...
  return (
    <>
      ...
      {/* What We Believe — the church's doctrinal statement, given its own
          band (bg-warm) so the white tenet cards stand out. Single readable
          column rather than the site's multi-column card sections. */}
      <section className="py-20 sm:py-24 bg-warm">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <div className="space-y-4 text-ink-soft leading-relaxed text-left">
          ...
          <p className="mt-14 pt-8 border-t border-warm-deep text-sm text-ink-soft italic text-center">
            {tenetsOutro}
          </p>
        </div>
      </section>
