...
export default function PayaccountStatusToggle({ payaccountId, active }: { payaccountId: number; active: boolean }) {
  ...
  async function toggle() {
    setBusy(true);
    try {
      const res = await fetch(`/bff/admin/payaccounts/${payaccountId}/status`, { method: "PATCH" });
      if (!res.ok) {
