        ...
        <div>
            <div class="bg-white border border-gray-200 rounded-2xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('web.guest.register.store') }}" novalidate>
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="mobile_no" value="{{ old('mobile_no') }}" required maxlength="10"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 {{ $errors->has('mobile_no') ? 'border-red-400' : '' }}"
